...
struct KindnessChallenge: Identifiable, Codable, Equatable, Hashable {
    let id: UUID
    let title: String
...
enum ChallengeCategory: String, Codable, CaseIterable, Identifiable, Hashable {
    ...
    var color: Color {
        switch self {
        case .strangers:  return Color(red: 0.98, green: 0.48, blue: 0.38)
        case .friends:    return Color(red: 0.56, green: 0.42, blue: 0.86)
        case .family:     return Color(red: 0.38, green: 0.76, blue: 0.55)
        case .colleagues: return Color(red: 0.27, green: 0.63, blue: 0.90)
        case .yourself:   return Color(red: 0.98, green: 0.75, blue: 0.28)
        case .community:  return Color(red: 0.96, green: 0.45, blue: 0.65)
        }
    }
...
// MARK: - StreakRecord
// Extended with referral bonus points tracking.
...
struct StreakRecord: Codable {
    ...
    // Referral system
    var bonusPoints: Int             // points earned from sharing challenges
    var sharedChallengeIDs: [UUID]   // challenges this user has shared
    var completedViaShareIDs: [UUID] // challenges completed after opening a share link

    static var empty: StreakRecord {
        StreakRecord(
            currentStreak: 0, longestStreak: 0, totalCompleted: 0,
            lastCompletedDate: nil, completedIDs: [],
            bonusPoints: 0, sharedChallengeIDs: [], completedViaShareIDs: []
        )
    }
    ...
    // Total score = completed challenges + bonus points from referrals
    var totalScore: Int { totalCompleted + bonusPoints }
}
...
extension KindnessChallenge {
    ...
    static let allChallenges: [KindnessChallenge] = [
        ...
        KindnessChallenge(title: "Plan a surprise for a friend",
            description: "Organise something small but unexpected — their favourite snack, a playlist, a movie night.",
            category: .friends, difficulty: .bold),
        KindnessChallenge(title: "Really listen",
            description: "In your next conversation with a friend, put your phone away and give them your complete attention.",
            category: .friends, difficulty: .easy),
        ...
        KindnessChallenge(title: "Do something you've been putting off",
            description: "Pick one thing from your mental 'I should do that' list and do it today.",
        ...
        KindnessChallenge(title: "Pick up litter on your street",
            description: "Spend 5 minutes picking up litter on your block or in a nearby park.",
            category: .community, difficulty: .easy),
        KindnessChallenge(title: "Donate to a local cause",
            description: "Find a local charity, food bank, or shelter and make a small or physical donation.",
    ...
    // Look up a challenge by its UUID — used by the deep link handler
    static func find(id: UUID) -> KindnessChallenge? {
